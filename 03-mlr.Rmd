...
### Residual plots
Residual plots for MLR were first discussed in Section \@(mlr-resid1) and they are used to check the **linearity** and **constant variance** MLR model assumptions. 
...
Here was can see the four cases with largest Cook's distance, along with their data values and case influence stats:
```{r}
library(broom)
...
Here we romove the SE ribbon and smoother from the standardized residual plot.
```{r}
ggnostic(sleep.lm3a, columnsY = c(".std.resid", ".hat", ".cooksd"), 
