...
For example, suppose we have $n$ plots of land and we plant $m_i$ seeds on each. A reponse $Y_i$ could be the number of seeds that germinate in plot $i$. Each seed has a $\pi(X_i)$ probability of germinating, and this probability could depend on plot-level predictors like amount of rain in plot $i$ or amount of fertilizer applied to plot $i$. 
