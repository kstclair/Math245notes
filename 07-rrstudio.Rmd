...
- **Browser:** You can access an online version of Rstudio from [mirage.mathcs.carleton.edu](). If you are new to using Rstudio, I  encourage you to use mirage rather than installing R/Rstudio on your computer. You can access mirage from anywhere on campus using Eduroam  wireless if on a laptop, but **from off campus** you will first need to turn on [Carleton's VPN](https://wiki.carleton.edu/display/itskb/GlobalProtect+VPN) prior to logging in. **Please install this software!** 
