...
When you exit Rstudio, you may be asked if you want to save your workspace as a .RData file before exiting. I strongly encourage you **not** to do this since it can make it very hard to reproduce your workflow (and it can slow down Rstudio start up). Instead, use R markdown (Section \@ref(markdown)) to document your workflow so you can redo any analysis that you've previously done.  
